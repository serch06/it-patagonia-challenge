...
export class TypeOrmCompanyRepository implements CompanyRepository {
  ...
  async save(company: Company): Promise<void> {
    ...
    try {
      ...
      throw new InternalServerErrorException('Failed to save company', {
  ...
  async findById(id: string): Promise<Company | null> {
    try {
      ...
      throw new InternalServerErrorException('Failed to fetch company by id', {
        cause: error as Error,
      });
    }
  }
  ...
  async findByName(name: string): Promise<Company | null> {
    try {
      ...
      throw new InternalServerErrorException(
        'Failed to fetch company by name',
        { cause: error as Error },
      );
    }
  }
